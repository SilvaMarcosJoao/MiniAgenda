...
def cadastrar(nome, telefone):
    ...
    nomeArq = 'Dados.txt'
    caminho = 'C:/Users/joaom/OneDrive/Ambiente de Trabalho/AgendaPy/Dados.txt'
    pessoa= [nome, telefone]
    try:
        if nomeArq in caminho:   
            arq = open(f'C:/Users/joaom/OneDrive/Ambiente de Trabalho/AgendaPy/{nomeArq}', 'a')
            arq.write(f'{pessoa}\n')
        else:
            arq = open(f'C:/Users/joaom/OneDrive/Ambiente de Trabalho/AgendaPy/{nomeArq}', 'wt+')
            arq.write(f'{pessoa}\n')
    except (FileNotFoundError, NotADirectoryError):
        print('\033[1;31mErro, ao salvar os dados\033[m')
    else:
...
def lerArquivo():
    ...
    try:
        if nomeArq in caminho:
            arq = open(f'C:/Users/joaom/OneDrive/Ambiente de Trabalho/AgendaPy/{nomeArq}', 'r')
...
def mostrarContato(lin):
    ...
    arq = 'C:/Users/joaom/OneDrive/Ambiente de Trabalho/AgendaPy/Dados.txt'
    print(' NOME  - TELEFONE')
